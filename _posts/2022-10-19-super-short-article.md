...
撮影をする際には、以下のことを心がけてください。<br>
・必ず、1/4以上の画像が重複するように撮る
・できるだけ水平を保つようにする
・オートフォーカス（自動焦点）を使わず、同じ焦点距離で撮影する
・明るさを変えずに、露出を固定して撮影する

撮影のコツ：ハンディカムは三脚を付けることができないため、回転式のオフィスチェアに座って周りながら撮影しました。意外と綺麗に撮影できました。
